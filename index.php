...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-link active" href="/classroom/">List<span class="sr-only">(current)</span></a>
            </li>
          <li class="nav-item active">
          ...
          while ($row = mysqli_fetch_assoc($results)){
              ?>
                <tr>
                      ...
                      <td>
                        <a href="/classroom/add.php?id=<?php echo $row['id']; ?> " class="btn btn-primary">EDIT</a>

                        <a href="/classroom/delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onClick="javascript:return confirm('Are you sure you want to delete');" >DELETE</a> 
                      </td> 
                </tr>   
